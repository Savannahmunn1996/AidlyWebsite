...
const Home = () => {
        ...
        <>
             <div className="text-center p-10">
                ...
                <a href="https://apps.apple.com/us/app/aidly-ai-chat/id6446067509" target="_blank" rel="noopener noreferrer" >
                    <button
                        type="submit"
                        className=" animate-bounce  w-80 h-14 mt-10  shadow-xl bg-gradient-to-r from-pink-800 to-purple-700 hover:from-purple-800 hover:to-blue-600 ... text-white  font-robo text-xl py-2 px-4 rounded-[16px] focus:outline-none"
                    >
                        Download for Free
                    </button>
                </a>
  ...
  <div className="w-96  ml-96 mt-96 px-3">
...
{/* phone */}
   <div className="w-80 h-90 pt-40 ml-auto mr-96">
    <div className="relative mt-8 md:mt-16 ">
      ...
      />
      <div className="absolute top-14 ml-7 h-full rounded-xl overflow-hidden">
        <ReactPlayer
