    ...
    <>
      <form>
        <div className="items-center grid grid-cols-1">
          <label htmlFor="message" className="text-4xl text-gray-700 font-semibold ml-10 mb-10">
            Dear Aidly team,
          </label >
          ...
          <button onClick={()=>sendMail()} className='text-Dpurp rounded-[18px] outline-2 md:outline-4 outline outline-Dpurp w-40 h-10 ml-10 mb-14 hover:bg-gray-200'>Send Message</button>
        </div>
      </form>
